...
export const OntologyViewWebVowl = ({ dataUrl }: OntologyViewType) => {
  ...
  const loadingModule = {
    ...
    getMessageVisibilityStatus: function () {
      return false;
    },
    getProgressBarMode: function () {
      return 1;
    },
    successfullyLoadedOntology: function () {
      return true;
    },
    missingImportsWarning: function () {
      return false;
    },
    ...
    requestServerTimeStampForDirectInput: function (
      callback: any,
      text: any
    ) {},
  ...
  const ontologyMenu = {
    ...
    callbackLoad_Ontology_From_DirectInput: function (
      text: any,
      parameter: any
    ) {},
    getConversionId: function () {
      return undefined;
    },
    callbackLoad_JSON_FromURL: function (parameter: any) {},
    callbackLoadFromOntology: function (
      selectedFile: any,
      filename: any,
      local_threadId: any
    ) {},
  ...
  const editSideBar = {
    ...
    checkForExistingURL: function (url: any) {
      return false;
    },
    checkProperIriChange: function (element: any, url: any) {
      return false;
    },
  ...
  const filterMenu = {
    ...
    getDefaultDegreeValue: function () {
      return 0;
    },
    ...
    getDegreeSliderValue: function () {
      return 0;
    },
    setup: function (
      datatypeFilter: any,
      objectPropertyFilter: any,
      subclassFilter: any,
      disjointFilter: any,
    ...
    getCheckBoxValue: function (id: any) {
      return false;
    },
    ...
    <>
      <Box p={4}>
        ...
        <Box mt={2} border="1px solid #ccc">
          ...
          <div id="emptyContainer" hidden>
            <a href="#opts=editorMode=true;#new_ontology1" id="emptyDisabled">
              Create new ontology
            </a>
          </div>
        </Box>
