...
- [CX - 0084 Federated Queries in Data Spaces (Knowledge Agents) v.1.0.0](#cx---0084-federated-queries-in-data-spaces-knowledge-agents-v100)
  ...
  - [2. Test Parameters for KA Conformity Assessment](#2-test-parameters-for-ka-conformity-assessment)
    - [2.4 Conformity Criteria](#24-conformity-criteria)
...
**Graph Assets** are a variant of ordinary Data Assets in the Catena-X EDC Standard; while Data Asset typically refer to an actual backend system (e.g., an Blob in an ObjectStorey, an AAS server, a REST endpoint), Graph Assets introduce another intermediary instance, the so-called Binding Agent.
...
To prove conformance of standard a test bed is necessary. Specification how such a test bed can be set up is given in **Tractus X, insert link**.

The Conformity Assessment Criteria (and the proposed Conformity Assessment Methods) will be listed in Chapter 2 for the respective building blocks that are relevant for KA Enablement.

## 2. Test parameters for KA conformity assessment

> _This section is normantive_

### 2.4 Conformity Criteria
...
<tbody>
 ...
 <tr>
  ...
  <td>MUST contain the released Semantic Model</td>
  <td>Assessed Party performs<br/> 02_ALL_EDC&gt;<br/> 020401_MODEL to demonstrate availablity<div></div></td>
 </tr>
 <tr>
  <td>Federated Catalog</td>
